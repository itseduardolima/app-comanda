...
## Critérios de aceite
- [x] `eas.json` configurado com pelo menos 3 perfis de build: `development` (com dev client, para testes internos), `preview` (build interno para distribuição ad-hoc/TestFlight interno) e `production` (build final de loja).
...
- [x] Documentação do processo de build/release registrada no `README.md` do `frontend/`.
