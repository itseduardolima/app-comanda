...
- **O protótipo manda no visual.** [Fogo e Brasa no Claude Design](https://claude.ai/design/p/0edee1ad-dd7e-41e4-b6a3-82d027c7bc6e), em dois arquivos: `App Garcom Fogo e Brasa.dc.html` (as 14 telas do MVP) e `App Garcom Fogo e Brasa v2 - Estados e Telas.dc.html` (estados, movimento, KDS — base dos sprints 7 e 8). Links e mapa telas→rotas em [`.specs/03-estilos.md` § Fonte do design](.specs/03-estilos.md#fonte-do-design).
